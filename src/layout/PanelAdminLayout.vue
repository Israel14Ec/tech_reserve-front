...
import { HomeIcon, BuildingLibraryIcon, CalendarIcon } 
...
const routeOptions = [
    { id: 1, name: 'Inicio', icon: HomeIcon, route: 'HomeAdmin' },
    { id: 2, name: 'Laboratorios', icon: BuildingLibraryIcon, route: 'ManageLabsAdmin' },
    { id: 2, name: 'Reservaciones', icon: CalendarIcon, route: 'ReservationsLabsAdmin' },
]
